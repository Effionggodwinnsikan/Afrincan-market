...
export const FilterModal: React.FC<FilterModalProps> = ({
  ...
  return (
    <>
      ...
      >
        <Fade in={open}>
          <div className=" flex flex-col border-0 overflow-scroll rounded-xl absolute gap-6 left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]  w-full  z-10  bg-white  modalContent modal__content  md:rounded-2xl shadow-md product-modal">
