    ...
    <>
      <header className="px-4 py-3 md:px-10 xl:px-0">
        <div className="flex items-center justify-between w-full max-w-6.5xl  mx-auto my-0 gap-3">
          <Link href={"/"}>
            <p className="text-white font-bold text-xl ">African Market</p>
          </Link>
          ...
          <div className="pointer-events-[initial] flex items-center lg:hidden relative">
            ...
            >
              <AccountCircleIcon className="text-white border-[#828080] border-1 text-4xl rounded-full" />
              {tooltip ? (
                <KeyboardArrowUpIcon
                  sx={{
                    color: "#fff",
            ...
            <div className="hidden lg:flex gap-4 items-center">
              {router.pathname != "/" && cart.length >= 1 && (
                <Badge badgeContent={totalItems} color="primary">
                  <ShoppingCartIcon
                    sx={{ cursor: "pointer", color: "#f7e9e9" }}
                    onClick={handleCart}
                  />
                </Badge>
              )}
              <div className="pointer-events-[initial] flex items-center  relative">
                <button
                  ...
                  onClick={handleTooltip}
                >
                  <AccountCircleIcon className="text-white border-white border-1 text-4xl rounded-full" />
                  {tooltip ? (
                    <KeyboardArrowUpIcon
                      sx={{
                        color: "#fff",
